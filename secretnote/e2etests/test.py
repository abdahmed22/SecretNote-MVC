...
class TestNavBar(StaticLiveServerTestCase):
    ...
    def test_secretnote(self):
        ...
        note_form.find_element(By.ID, 'id_text').send_keys("secret note secret note secret note secret note")
        ...
        self.assertEquals(note_detail.find_element(By.ID, 'text').text, 'secret note secret note secret note secret note')
